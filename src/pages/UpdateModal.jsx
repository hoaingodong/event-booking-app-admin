            ...
            <div className="modal__backdrop">
                <div className="modal__container">
                    ...
                    <form id="create-form" method="POST" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input id="title" type="text" name="title" defaultValue = {eventDetail?.title} required />
                            ...
                            <div className="modal__image">
                                <div>
                                    ...
                                    <input type="file" id="images" accept="image/*" name="files" {...register("file")} disabled required/>
                                    </label>
                                </div>
                            </div>
